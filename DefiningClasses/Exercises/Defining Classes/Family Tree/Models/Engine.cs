namespace Family_Tree.Models
{
    ...
    public class Engine
    {
        ...
        private Dictionary<string, Person> peopleByName;
        private Dictionary<string, Person> peopleByBirthday;

        public Engine()
        {
            this.peopleByName = new Dictionary<string, Person>();
            this.peopleByBirthday = new Dictionary<string, Person>();
        }
